...
<body >
<header>
    <h1 class="text-center" style="background-color: #f48fb1;">Admin Add Role</h1>
  </header>
<br><br><div class="container">
    <form action="addCV" method="post">
    <div class="mb-3 mt-5">
        <label  class="form-label">Tên chức vụ </label>
        <input type="text" class="form-control" name="tenchucvu"  placeholder="Nhập tên chức vụ...."> <br>
        <button type="submit" class="btn btn-success" name="addCV">Thêm mới</button>
    </div>
