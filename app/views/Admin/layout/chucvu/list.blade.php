...
<div id="content">
  ...
  <table>
    ...
    <tbody>
      <?php foreach ($getCV as $key => $value) { ?>
          <tr>
            <td><?php echo $value['id']; ?></td>
            <td><?php echo $value['ten_chuc_vu']; ?></td>
            <td>
            <a href="formupdateCV&id={{$value['id']}}"><input type="submit" name="suatk" value="Edit" class="styled-button"></a>
              <a href="deleteCV&id={{$value['id']}}"><input type="submit" name="xoatk" value="Delete" class="styled-button" onclick="return confirm('Bạn có muốn xóa không?')"></a>
            </td>
        </tr>
      <?php  } ?>
    </tbody>
  </table>
  <br> <br><a href="formaddCV"><input type="submit" value="Thêm mới" class="styled-button"></a>
</div>
