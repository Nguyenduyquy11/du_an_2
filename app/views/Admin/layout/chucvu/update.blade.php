...
<body >
<header>
    <h1 class="text-center" style="background-color: #f48fb1;">Admin Update Role</h1>
  </header>
<br><br><div class="container">
    <form action="updateCV" method="post">
    <div class="mb-3 mt-5">
        <label  class="form-label">Tên chức vụ </label>
        <input type="text" class="form-control" name="tenchucvu"  value="{{$getOneCV['ten_chuc_vu']}}"> <br>
        <input type="hidden" name="id" value="{{$getOneCV['id']}}">
        <button type="submit" class="btn btn-success" name="updateCV">Thêm mới</button>
    </div>
