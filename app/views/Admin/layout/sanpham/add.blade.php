...
<br><br><div class="container">
    ...
    <div class="mb-3 mt-5">
        ...
        <input type="text" class="form-control" name="tensanpham"  placeholder="Nhập tên sản phẩm...."> <br>
        ...
        <input type="text" class="form-control" name="mota"  placeholder="Nhập mô tả sản phẩm...."> <br>
        ...
        <input type="text" class="form-control" name="gia"  placeholder="Nhập giá sản phẩm...."> <br>
        ...
        <button type="submit" class="btn btn-success" name="addSP">Thêm mới</button>
    </div>
