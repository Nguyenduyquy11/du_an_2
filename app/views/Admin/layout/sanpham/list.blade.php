...
<div id="content">
  ...
  <table>
    ...
    <tbody>
      <?php foreach ($listSP as $key => $value) { ?>
          <tr>
            <td><?php echo $value['id']; ?></td>
            <td><?php echo $value['ten_san_pham']; ?></td>
            <td><?php echo $value['gia']; ?></td>
            <td><img src="<?php echo $value['anh_sp']; ?>" width="100px"></td>
            <td><?php echo $value['mo_ta']; ?></td>
            <td><?php echo $value['ten_danh_muc']; ?></td>
            <td>
            <a href="formupdateSP&id={{$value['id']}}"><input type="submit" name="suatk" value="Edit" class="styled-button"></a>
              <a href="deleteSP&id={{$value['id']}}"><input type="submit" name="xoatk" value="Delete" class="styled-button" onclick="return confirm('Bạn có muốn xóa không?')"></a>
            </td>
        </tr>
      <?php  } ?>
    </tbody>
  </table>
  <br> <br><a href="formaddsp"><input type="submit" value="Thêm mới" class="styled-button"></a>
</div>
